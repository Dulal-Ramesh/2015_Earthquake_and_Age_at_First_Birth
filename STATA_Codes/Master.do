...
*                 Step 1 data-cleaning file in sequence.                        *
* Last Updated  : March 2026                                                    *
********************************************************************************

*==============================================================================*
*   SECTION 1: GLOBAL PATH DEFINITIONS                                         *
*   → This is the ONLY place you need to change paths.                         *
*==============================================================================*
...
else if "`c(username)'" == "drghosh" {        // ← replace with your actual username (To check the username in STATA command type "display c(username)")
...
local today = string(date(c(current_date), "DMY"), "%tdCYND")
...
display as text "========================================================"
display as text " STEP 2: Variable Definitions - Couple & Women"
display as text "========================================================"
...
log close
display as text "✓ All steps completed successfully."
